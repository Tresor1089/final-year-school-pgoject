...
<div id="school_header">
        ...
        <p><img src="../images/ecole.png" width="872" height="125" /></p>
        <p>&nbsp;</p>
      </div>
      <!-- end of site_title -->
      ...
      <div id="login">
        <form  method="post" name="form" onsubmit="return validateForm()">
          <table height="196" id='mytable'>
            ...
            <tr>
              <td style="padding-top:12px;">CATEGORIE:</td>
              <td>&nbsp;</td>
...
?>
	...
	?>
		...
		?>
        <p align="center">  UTILISATEUR OU MOT DE PASSE INCORRECT</p>
        <br />
        <br />
        .........
        <p align="center">
...
<img src="images/ec.jpg" width="260" height="250" style="margin:30px; border-radius:5px; border:3px double #FF9966;" />
<div class="cleaner"></div>
</div>
<!-- end of main -->
