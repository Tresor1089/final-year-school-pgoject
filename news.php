...
<body><div>
<h1><center>
  CSC SAINTE VICTRORINE 
</center></h1><br/></div>
<div class="menu"> Links
<br/><ul class="menu1">
<li><span class="style1"><a href='home.php'><img src="images/120.png" width="30" height="30" /><img src="images/spacer.gif" />ACUEIL</a></span></li>
<li class="style2"><a href='#'> <img src="images/46.png" width="30" height="30" /><img src="images/spacer.gif" />INSCRIRE</a>
  <ul class="menu2">
 <li><a href='register.php'>ELEVE</a></li>
 <li><a href='register1.php'>ENSEIGANT</a></li>
 <li><a href='register2.php'>EMPLOYE</a></li>
 </ul></li>
<li class="style3"><a href='#'><img src="images/my_documents.png" width="30" height="30" /><img src="images/spacer.gif" />MTTRE A JOUR </a>
  <ul class="menu3">
 <li><a href='recordstudent.php'>LES ELEVES </a></li>
 <li><a href='recordteacher.php'>LES ENSEGANTS</a></li>
 <li><a href='recordnonstaff.php'>LES EMPLOYES </a></li>
 </ul></li>

<li><a href='#'><img src="images/Wholesale.png"  width="30" height="30" /> <img src="images/spacer.gif" />PAYEMENT</a>
  <ul class="menu3">
 <li><a href='studentmoney.php'>ENTRER UN PAYEMENT </a></li>
 <li><a href='viewpay.php'>VOIRLES PAYEEMNTS </a></li>
 </ul></li>  </ul></div>
