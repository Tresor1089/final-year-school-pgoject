...
<div id="school_body_wrapper">
  <div id="school_wrapper">
    <div id="school_header">
      <div><img src="images/ecole.PNG" width="1024" height="125" /> </div>
      <!-- end of site_title -->
        ...
        <ul>
          ...
          <li><a href="#">METTRE AJOUR </a>
            <ul>
              ...
              <li><a href='?action=non'>AJOUTER UN EMPLOYE</a></li>
              <li><a href='?action=salaryin'>PAYE DE L'ENSIGNANT</a></li>
              <li><a href='?action=salarynon'>PAYE DES EMPLOYES</a></li>
              <li><a href='?action=bursary'>ELEVES BOURSIERS</a></li>
            </ul>
          </li>
          <li><a href="#">VOIR LES DONNES</a>
            <ul>
              <li><a href='?action=recordstudent'>ELEVES</a></li>
              <li><a href='?action=onbursary'>ELEVE BOURSIERS </a></li>
              <li><a href='?action=recordteacher'>ENSEIGNANT</a></li>
              <li><a href='?action=tattend'>ENSEIGNANT PRESENT</a></li>
              <li><a href='?action=recordnonstaff'>EMPLOYE</a></li>
              <li><a href='?action=report'> BULLETIN </a></li>
			  <li><a href='?action=trans'>EVOLUTON TRIMESTRIELLE</a></li>

              <li><a href='?action=viewpay'>PAYEMENT DE L'ELEVE</a></li>
              <li><a href='?action=unpaid'>ELEVE EN DETTE</a></li>
            </ul>
          </li>
          <li><a href="#">ASSICIATIONS</a>
            <ul>
              <li><a href='?action=viewclubs'>ASSICIATIONS DISPO</a></li>
              <li><a href='?action=rclubs'>NOUVELLE ASSOCIATION</a></li>
              <li><a href='?action=member'>AJOUTER UN ELEVE</a></li>
              <li><a href='?action=clubmember'>MEMBRES </a></li>
            </ul>
          </li>
    ...
    <div id="school_main">
      <div id="sidebar" class="float_r">
        <div class="sidebar_box"><span class="bottom"></span>
          <h3>LE STAFF</h3>
          <div class="content"> Deplacer la souris ici pour mettre une Pause<br/>
      ...
      <div id="content" class="float_l"> <br/>
        ...
        <div id="slider-wrapper">
          <div id="slider" class="nivoSlider"> <img src="images/st.jpg" alt="image" width="680" title="photo 1"  /> <a href="#"><img src="images/ecc.jpg" alt="" width="680" title="photo 2" /></a> <img src="images/ecoleé.jpg" alt="image" width="680" title="photo 3" /> <img src="images/ec.jpg" alt="image" width="680" title="photo 4" /> <img src="images/ecoleé.jpg" alt="image" width="680" title="photo 5" title="##htmlcaption"   /> <img src="images/ecc.jpg" alt="image" width="680" title="photo 6" /> <img src="images/ecoleé.jpg" alt="image" width="680" title="photo 7" /> <div>
        </div>
        ...
        <p>&nbsp;</p>
        <h1>ECOLE MODERNE COMPLEXE SCOLAIRE SAINTE VICTORINE </h1>
      </div>
      <div class="product_box">
        <?php }
							  else if($action=='teacher'){//---------------------------------------------------------------------------------------------
			?>
        <p>NOUVEAU ENSEIGNANT</p>
        <p>&nbsp;</p>
        <form action="?action=registered1" method="post" name="myform">
          <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
			...
			<tr>
              ...
              <td >&nbsp;</td>
              <td ><input type="text" name="Password" size="30" id='in'title="enter you first name here" required></td>
            </tr>
            <tr>
              <td>SEXE</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td align="right"><input type="submit" name="send" id='send'value="ENREGISTRER" />
      ...
      <?php
			...
			$qual=$_POST['quality'];
			$salary=$_POST['salary'];
			$insert= mysql_query("INSERT INTO  teacher(TEACH_ID, SALARY, CREDIT)VALUES ('$fnames','$password','$sex','$age','quality','$salary')");
			$ins= mysql_query("INSERT INTO  teacher VALUES ('','$fnames','$password','$sexs','$ages','$qual','$salary','Active')");
      ...
      <form action="?action=registered2" method="post" name="myform">
        <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td align="right"><input type="submit" name="send" id='send'value="ENREGISTRER" />
              <input type='reset' id='clear'name="clear" value="ANULER"  /></td>
          </tr>
        </table>
      </form>
    ...
    <a href="print.php">IMPRIMER LES DONNEES </a>
    <?php 
  ...
  <?php
			...
			echo '<th>NAMES</th><th>PASSWORD</th><th>SEX</th><th>AGE</th><th>QUALIFICATION</th><th>STATUS</th><th colspan=2>ACTION</th>';
			$rowcolor=0;
			...
			echo '<tr><td>'.$fetch['1'].'</td><td>'.$fetch['PASSWORD'].'</td><td>'.$fetch['SEX'].'</td><td>'.$fetch['AGE'].'</td><td align="middle">'.$fetch['QUALITY'].'</td><td>'.$fetch['STATUS'].'</td><td><a href=modifytr.php?id='.$fetch['TEACH_ID'].'><img src="images/edit-icon.png" width=30 height=30 title=MODIFY_RECORD /></a></td><td><a href=deletetr.php?id='.$fetch['TEACH_ID'].'><img src="images/deletee.png" width="30" height="30" title=DELETE_RECORD /></a></td></tr>';
      ...
      <td>ELEVE:
        ...
        <?php
								...
								?>
												...
												<option value="PREMIER TRIM">1er TRIM</option>
                 							 <option value="SECOND TRIM">2nd TRiM</option>
                  							<option value="TROISIEM TRIM">3em TRiM </option>
												</select>
        <input type="submit" name="go"  value="VOIR BULLETIN" id='n' />
      </td>
    </tr>
  </table>
</form>
...
<form action="" method="post" name="myform">
  <table  border="0" cellspacing="3" cellpadding="5" id="mytable" >
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align="right"><input type="submit" name="sen" id='send'value="ENREGISTRER" />
        <input type='reset' id='clear'name="clear" value="ANNULER"  /></td>
    </tr>
  </table>
</form>
...
<?php
			...
			?>
<div style="float:left">FRAIS SCHOLAIRE</div>
<div  style="float:right"><a href="?action=item">AUTRES</a> </div>
<p style="height:30px"></p>
<form action="" method="post" >
  <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
    <tr>
      <td align="right" colspan="3"><input type="text" name="tution" placeholder="MONTANT A PAYER" required /></td>
      </td>
    </tr>
    <tr>
      <td  height="24">NOMS</td>
      <td >&nbsp;</td>
    ...
    <tr>
      ...
      <td><select name="class"  title="senior ?">
          <option value="SENIOR ONE">1ER</option>
          <option value="SENIOR TWO">2EM</option>
          <option value="SENIOR THREE">3EM</option>
          <option value="SENIOR FOUR">4EM</option>
          <option value="SENIOR FIVE">5EM</option>
          <option value="SENIOR SIX">6EM</option>
        </select></td>
    </tr>
    <tr>
      <td>TRIMESTRE</td>
      ...
      <td><select name="term"  title="Term">
          <option value="FIRST TERM">1ER TRIM</option>
          <option value="SECOND TERM">2ND TRIM</option>
          <option value="THIRD TERM">3EM TRIM</option>
        </select></td>
    </tr>
    <tr>
      <td>ANNEE</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td valign="bottom" align="center"><input type="submit" name="send" id='send'value="ENREGISTRER" />
        <input type='reset' id='clear'name="clear" value="ANNULER"  /></td>
    </tr>
  </table>
</form>
...
<form action="" method="post" name="clubform" onSubmit="MM_validateForm('clubcode','','R','clubname','','R','description','','R','chairman','','R','patron','','R');return document.MM_returnValue">
  <table  id="mytable">
    ...
    <tr>
      <td></td>
      <td><input type="submit" name="enter" value='ENREGISTRER' id='in'/>
        <input type="reset" name="reset" value='ANNUELR' id='in'/>
      </td>
    </tr>
  </table>
</form>
...
<form action="" method="post" name="stclub" onSubmit="MM_validateForm('clubid','','R','studentid','','R');return document.MM_returnValue">
  <table  id="mytable">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" name="sub" value="ENREGISTRER"  />
        <input type="reset" name="reset" value="ANNUELR" /></td>
    </tr>
  </table>
</form>
<?php
...
<form id="mytable" method="post">
  ...
  <input type="submit" name="do" value="CONTINUER" />
</form>
<?php
			if (isset($_POST['do'])){ 
			$id=$_REQUEST['tid'];
...
<form  method="post" name="myform">
  <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
    <tr>
      <td  height="24">NOMS</td>
      <td >&nbsp;</td>
      <td ><input type="text" name="fname2" size="30" id='fname' value="<?php echo $fetch['NAMES'] ?>"  /></td>
    </tr>
    <tr>
      <td>SEXE</td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><input type="text" name="paid" size="30" id='in' value="<?php echo $fetch['PAYAMOUNT'] ?>" />
        <br>
        <font size="-1">Remplace le montant ci dessus pour completer le payement </font></td>
    </tr>
    <tr>
      <td>CREDIT</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>DATE PAYEMENT PREMIER TRANCHE </td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>DATE PAYE DERNIER TANCHE </td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align="right"><input type="submit" name="send" id='send'value="METTRE AJOUR" />
        <input type='reset' id='clear'name="clear" value="ANNULER"  /></td>
    </tr>
  </table>
...
<form  method="post" name="myform">
  <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
    ...
    <tr>
      ...
      <td><input type="text" name="paid" size="30" id='in' value="<?php echo $fetch['PAYAMOUNT'] ?>" />
        <br>
        <font size="-1">Remplacer le montant dessus pour completer le payement </font></td>
    </tr>
    <tr>
      <td>CREDIT</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>DATE DU PREMIER PAYEMENT </td>
      <td>&nbsp;</td>
      <td><input type="text" name="date1" size="30" id='in' value="<?php echo $fetch['DAYPAY1'] ?>"  />
        <br/>
        <font color="grey" size="-1">AAA-MM-JJ</font></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align="right"><input type="submit" name="send" id='send'value="METRE A JOUR" />
        <input type='reset' id='clear'name="clear" value="ANNULER"  /></td>
    </tr>
  </table>
...
<table style="border: 3px double #FF6600; background:url(images/powder.gif);background-size:cover; padding:12px; color:#003366">
  <tr>
    <td scope="col" colspan="3" align="center"><h1>CARTE D'ELEVE </h1></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td width="175" height="34">NOM</td>
