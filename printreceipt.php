...
<div id="school_wrapper">
	...
	<div id="school_header">
		<div id="site_title"> <a href="#">ECOLE MODERNE CSC SAINTE VICTORINE </a>        </div>
...
$fetch=mysql_fetch_array($sel)
 ...
 <tr>
   <td height="63" colspan="3"  >copy de l'eleve
     <center>
     <font size="+1" style="letter-spacing:5px; font-weight:900;"> 
	 ECOLE MODERNE COMPLEXE SCOLAIRE SAINTE VICTORINE<br>
     </font><font size="+0" style="letter-spacing:0px;"> 
	 	P.O BOX: ....... Butembo<br>
		Tel:
		<hr>

	  COPY </font>
     <font size="+0" style="letter-spacing:0px;">OFFICIELLE</font>
     </center></td></tr>
   <tr>
     <td width="15%"  height="43">Reçu Nom. <?php echo 'A'.$confirmation; ?></td>
     <td >&nbsp;</td>
     <td >date de payement: <?php   echo ''.$fetch['9'].''      ?></td>
   </tr>
   <tr>
     <td>Eleve  No. <?php  echo ''.$fetch['0'].'' ?></td>
     <td>&nbsp;</td>
     <td>&nbsp;</td>
   </tr>
   <tr>
     ...
     <td>&nbsp;</td>
     <td>Année : <?php  echo ''.$fetch['4'].'' ?></td>
   </tr>
   <tr>
     <td>Classe: <?php  echo ''.$fetch['2'].'' ?></td>
     <td>&nbsp;</td>
     <td>trimestre: <?php  echo ''.$fetch['3'].'' ?></td>
   </tr>
   <tr>
     <td>&nbsp;</td>
     <td>&nbsp;</td>
   ...
   <tr>
     <td>Arrierés: <strike>76800000</strike></td>
     <td>frais scolaire  : <?php  echo ''.$fetch['5'].'' ?></td>
     <td>Montant convenable : <?php  echo ''.$fetch['7'].'' ?></td>
   </tr>
   <tr>
     <td> montant payé :       <?php  echo ''.$fetch['6'].'' ?> </td>
     <td>Reste: <?php  echo ''.$fetch['8'].'' ?></td>
     <td>&nbsp;</td>
   </tr>
   ...
   <tr>
     <td colspan="3"  align="center"><i><hr>
         <hr/></i></td>
   ...
   <tr>
     <td rowspan="2"  valign="top">siganture authorisé &Seau</td>
     <td>&nbsp;</td>
     <td rowspan="2">Imprimé le:<br/> 
       <?php
   ...
   <tr>
     <td height="46" colspan="3" align="center"><p>NE PERDEZ PAS CE RECU !!!! </p>
       </td>
...
?>
  <table style="border: 3px double #FF6600; background:url(images/powder.gif);background-size:cover; padding:12px; color:#003366">
    ...
    <tr>
      <td height="38">DATE D'INSRCIPTION </td>
...
<?php
    ...
    <div id="school_footer">
    	      <div align=center> Copyright &copy; 2015-2016 CSC SAINTE VICTORINE </div>
