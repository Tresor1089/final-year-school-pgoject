...
<body><div class="heading"><h1><center>CSC COLAIRE SAINTE VICTORINE</center></h1><br/></div>

<div class="menu"><ul class="menu1">
<li><a href='home.php'><i class="icon-home icon-large"></i>&nbsp;<img src="images/120.png" width="30" height="30" /><img src="images/spacer.gif" />ACUEIL</a></li>
<li><a href='#'> <img src="images/46.png" width="30" height="30" /><img src="images/spacer.gif" />INSCRIRE</a>
  <ul class="menu2">
 <li><a href='register.php'>NOUVEAU ELEVE</a></li>
 <li><a href='register1.php'>NOUVEAU ENSEIGANT </a></li>
 <li><a href='register2.php'>NOUVEAU EMPLOYE </a></li>
 </ul></li>
<li><a href='#'><img src="images/my_documents.png" width="30" height="30" /><img src="images/spacer.gif" />METTRE AJOUR </a>
	<ul class="menu3">
 <li><a href='recordstudent.php'>LES ELVES </a></li>
 <li><a href='recordteacher.php'>LES ENSEIGNANT </a></li>
 <li><a href='recordnonstaff.php'>LES EMPLOYEE </a></li>
 </ul></li>
<li><a href='#'><img src="images/Wholesale.png"  width="30" height="30" /> <img src="images/spacer.gif" />LES PAYEMENTS </a>
  <ul class="menu3">
 <li><a href='studentmoney.php'>ENTEER UN PAYEMENT </a></li>
 <li><a href='viewpay.php'>VOIR LES PAYEMENTS </a></li>
 </ul></li>  </ul></div>
 <table width="1218"  cellspacing="3" cellpadding="0">
  <tr>
    <td width="367"><div class='name'> 
  <p>E M CSC SAINTE VICTORINE </p>
</div></td>
